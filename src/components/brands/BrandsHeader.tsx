...
function BrandsHeader({searchTerm, setSearchTerm, isAdmin}: BrandsHeaderProps) {
  ...
  return (
    <header className="relative w-full h-32 bg-bg flex flex-wrap justify-between items-center md:px-10 border-b-2 border-button-yellow">
            <div className="order-1">
                <h1 className="text-3xl font-heading font-semibold">MARKALAR</h1>
            </div>
            ...
            {isAdmin && (
                <div className="order-2 md:order-3">
                    ...
                    >
                        ...
                        <span className="text-text-inverse font-heading font-semibold">Marka Ekle</span>
                    </button>
                </div>
            )}
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center backdrop-blur-sm bg-black/50 p-4" onClick={() => setIsModalOpen(false)}>
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in duration-300" onClick={(e) => e.stopPropagation()}>
                        <div className="flex justify-between items-center p-6 border-b border-zinc-100 bg-zinc-50/50">
                            <h2 className="text-xl font-bold text-zinc-800">Yeni Marka Ekle</h2>
